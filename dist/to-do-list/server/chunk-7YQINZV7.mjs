...
var _EventService = class _EventService {
  ...
  listen(eventName, callback) {
    this.subject.asObservable().subscribe((nextObj) => {
...
// src/app/task/todo-list-task/todo-list-task.component.ts
var _TodoListTaskComponent = class _TodoListTaskComponent {
  constructor(event) {
    this.event = event;
  }
...
_TodoListTaskComponent.\u0275fac = function TodoListTaskComponent_Factory(t) {
  return new (t || _TodoListTaskComponent)(\u0275\u0275directiveInject(EventService));
};
_TodoListTaskComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TodoListTaskComponent, selectors: [["todo-list-task"]], inputs: { task: "task" }, decls: 7, vars: 3, consts: [[1, "d-flex", "justify-content-between", "align-middle"], [1, "ps-1"], [3, "ngClass"], ["type", "checkbox", 1, "rounded-5", "align-middle", "me-1", 3, "checked", "click"], ["type", "button", 1, "btn-close", 3, "click"]], template: function TodoListTaskComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "li", 0)(1, "div", 1)(2, "div", 2)(3, "input", 3);
    \u0275\u0275listener("click", function TodoListTaskComponent_Template_input_click_3_listener() {
      return ctx.toggleFulfilled();
    });
    \u0275\u0275elementEnd();
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div")(6, "button", 4);
    \u0275\u0275listener("click", function TodoListTaskComponent_Template_button_click_6_listener() {
  ...
  if (rf & 2) {
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", ctx.cssClases);
    \u0275\u0275advance(1);
    \u0275\u0275property("checked", ctx.task.isComplete);
    \u0275\u0275advance(1);
    \u0275\u0275textInterpolate1(" ", ctx.task.toDoText, " ");
  }
}, dependencies: [NgClass], styles: ["\n\n.strike[_ngcontent-%COMP%] {\n  text-decoration: line-through;\n}\ninput[type=checkbox][_ngcontent-%COMP%] {\n  accent-color: #150b46;\n  width: 1em;\n  height: 1.5rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
var TodoListTaskComponent = _TodoListTaskComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TodoListTaskComponent, { className: "TodoListTaskComponent", filePath: "src\\app\\task\\todo-list-task\\todo-list-task.component.ts", lineNumber: 11 });
})();

// src/app/task/todo-list/todo-list.component.ts
function TodoListComponent_div_0_Template(rf, ctx) {
  if (rf & 1) {
...
function TodoListComponent_ng_template_1_todo_list_task_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "todo-list-task", 5);
  }
  if (rf & 2) {
...
function TodoListComponent_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, TodoListComponent_ng_template_1_todo_list_task_1_Template, 1, 1, "todo-list-task", 4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
var _TodoListComponent = class _TodoListComponent {
  constructor() {
    this.tasks = [];
  }
};
_TodoListComponent.\u0275fac = function TodoListComponent_Factory(t) {
  return new (t || _TodoListComponent)();
};
_TodoListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TodoListComponent, selectors: [["todo-list"]], inputs: { tasks: "tasks" }, decls: 3, vars: 2, consts: [[4, "ngIf", "ngIfElse"], ["showItems", ""], [1, "ps-1"], [1, "p-0"], [3, "task", 4, "ngFor", "ngForOf"], [3, "task"]], template: function TodoListComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, TodoListComponent_div_0_Template, 3, 0, "div", 0)(1, TodoListComponent_ng_template_1_Template, 2, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
  }
  if (rf & 2) {
    const _r2 = \u0275\u0275reference(2);
    \u0275\u0275property("ngIf", ctx.tasks.length == 0)("ngIfElse", _r2);
  }
}, dependencies: [NgForOf, NgIf, TodoListTaskComponent], styles: ["\n\n/*# sourceMappingURL=data:application/json;base64,ewogICJ2ZXJzaW9uIjogMywKICAic291cmNlcyI6IFtdLAogICJzb3VyY2VzQ29udGVudCI6IFtdLAogICJtYXBwaW5ncyI6ICIiLAogICJuYW1lcyI6IFtdCn0K */"] });
var TodoListComponent = _TodoListComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TodoListComponent, { className: "TodoListComponent", filePath: "src\\app\\task\\todo-list\\todo-list.component.ts", lineNumber: 10 });
})();

// src/shared/models/toDoItem.ts
var ToDoItem = class {
  constructor(toDoText, isComplete = false) {
...
// src/app/task/add-task-form/add-task-form.component.ts
var _AddTaskFormComponent = class _AddTaskFormComponent {
  constructor() {
    this.newTaskText = "";
...
_AddTaskFormComponent.\u0275fac = function AddTaskFormComponent_Factory(t) {
  return new (t || _AddTaskFormComponent)();
};
_AddTaskFormComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AddTaskFormComponent, selectors: [["add-task-form"]], outputs: { addTask: "addTask" }, decls: 7, vars: 1, consts: [[1, "fs-3", "mb-4"], [1, "mb-2", "d-flex", "justify-content-center"], ["type", "text", "name", "new-task", "placeholder", "Add your task", 1, "form-control", 3, "ngModel", "ngModelChange"], ["type", "submit", 1, "btn", "color-background", "text-light", "mx-1", 3, "click"]], template: function AddTaskFormComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "form")(1, "h1", 0);
    \u0275\u0275text(2, "To-Do List");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 1)(4, "input", 2);
    \u0275\u0275listener("ngModelChange", function AddTaskFormComponent_Template_input_ngModelChange_4_listener($event) {
      return ctx.newTaskText = $event;
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 3);
    \u0275\u0275listener("click", function AddTaskFormComponent_Template_button_click_5_listener($event) {
  ...
  if (rf & 2) {
    \u0275\u0275advance(4);
    \u0275\u0275property("ngModel", ctx.newTaskText);
  }
}, dependencies: [\u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, NgModel, NgForm], styles: ["\n\nbutton[_ngcontent-%COMP%]:hover {\n  border: 1px solid #150b46;\n  color: #150b46 !important;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
var AddTaskFormComponent = _AddTaskFormComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AddTaskFormComponent, { className: "AddTaskFormComponent", filePath: "src\\app\\task\\add-task-form\\add-task-form.component.ts", lineNumber: 10 });
})();

// src/app/task/task-filter/task-filter.component.ts
var filters = [
  (item) => item,
...
_TaskFilterComponent.\u0275fac = function TaskFilterComponent_Factory(t) {
  return new (t || _TaskFilterComponent)();
};
_TaskFilterComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TaskFilterComponent, selectors: [["task-filter"]], inputs: { filter: "filter" }, outputs: { filterChange: "filterChange" }, decls: 7, vars: 1, consts: [[1, "w-auto", "border", "rounded-2", "mb-2", 3, "ngModel", "ngModelChange"], ["value", "0"], ["value", "1"], ["value", "2"]], template: function TaskFilterComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "select", 0);
    \u0275\u0275listener("ngModelChange", function TaskFilterComponent_Template_select_ngModelChange_0_listener($event) {
      return ctx.listFilter = $event;
    })("ngModelChange", function TaskFilterComponent_Template_select_ngModelChange_0_listener($event) {
  ...
  if (rf & 2) {
    \u0275\u0275property("ngModel", ctx.listFilter);
  }
}, dependencies: [NgSelectOption, \u0275NgSelectMultipleOption, SelectControlValueAccessor, NgControlStatus, NgModel], styles: ["\n\n/*# sourceMappingURL=data:application/json;base64,ewogICJ2ZXJzaW9uIjogMywKICAic291cmNlcyI6IFtdLAogICJzb3VyY2VzQ29udGVudCI6IFtdLAogICJtYXBwaW5ncyI6ICIiLAogICJuYW1lcyI6IFtdCn0K */"] });
var TaskFilterComponent = _TaskFilterComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TaskFilterComponent, { className: "TaskFilterComponent", filePath: "src\\app\\task\\task-filter\\task-filter.component.ts", lineNumber: 14 });
})();

// src/app/task/task.component.ts
var _TaskComponent = class _TaskComponent {
  constructor(event) {
    this.items = [];
    event.listen("removeTask", (task) => {
...
_TaskComponent.\u0275fac = function TaskComponent_Factory(t) {
  return new (t || _TaskComponent)(\u0275\u0275directiveInject(EventService));
};
_TaskComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TaskComponent, selectors: [["app-task"]], decls: 4, vars: 2, consts: [[1, "container"], [3, "addTask"], [3, "filter", "filterChange"], [3, "tasks"]], template: function TaskComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "add-task-form", 1);
    \u0275\u0275listener("addTask", function TaskComponent_Template_add_task_form_addTask_1_listener($event) {
      return ctx.items.push($event);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "task-filter", 2);
    \u0275\u0275listener("filterChange", function TaskComponent_Template_task_filter_filterChange_2_listener($event) {
      return ctx.filterTasks = $event;
    });
    \u0275\u0275elementEnd();
    \u0275\u0275element(3, "todo-list", 3);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(2);
    \u0275\u0275property("filter", ctx.filterTasks);
    \u0275\u0275advance(1);
    \u0275\u0275property("tasks", ctx.items.filter(ctx.filterTasks));
  }
}, dependencies: [TodoListComponent, AddTaskFormComponent, TaskFilterComponent], styles: ["\n\n/*# sourceMappingURL=data:application/json;base64,ewogICJ2ZXJzaW9uIjogMywKICAic291cmNlcyI6IFtdLAogICJzb3VyY2VzQ29udGVudCI6IFtdLAogICJtYXBwaW5ncyI6ICIiLAogICJuYW1lcyI6IFtdCn0K */"] });
var TaskComponent = _TaskComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TaskComponent, { className: "TaskComponent", filePath: "src\\app\\task\\task.component.ts", lineNumber: 13 });
})();
...
_AppComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppComponent, selectors: [["app-root"]], decls: 2, vars: 0, consts: [[1, "border", "w-100", "bg-light", "rounded", "p-4"]], template: function AppComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "main", 0);
    \u0275\u0275element(1, "app-task");
    \u0275\u0275elementEnd();
  }
}, dependencies: [TaskComponent], styles: ["\n\nmain[_ngcontent-%COMP%] {\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  width: 100%;\n}\n/*# sourceMappingURL=data:application/json;base64, */"] });
...
var _TaskModule = class _TaskModule {
};
_TaskModule.\u0275fac = function TaskModule_Factory(t) {
  return new (t || _TaskModule)();
};
_TaskModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({ type: _TaskModule });
_TaskModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({ imports: [
  CommonModule,
  FormsModule,
  HttpClientModule
] });
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-7YQINZV7.mjs.map
